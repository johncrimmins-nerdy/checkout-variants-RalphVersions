...
import electronicPolicy from '@/lib/content/electronic-policy';
...
/**
 * Electronic Policy page
 * Serves exact HTML content from original checkout-ts implementation
 */
export default function ElectronicPolicyPage() {
  return (
    <div className="page-wrapper">
      ...
      <div className="page-main">
        <section>
          <div className="container" id="electronic-policy-content">
            <div className="u-mt-100vn" />
            {/* Content injected here - same as original JS injection */}
            <div dangerouslySetInnerHTML={{ __html: electronicPolicy }} />
          </div>
        </section>
      </div>
