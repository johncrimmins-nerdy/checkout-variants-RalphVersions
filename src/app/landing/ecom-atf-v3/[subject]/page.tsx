...
import { CompactDiagnosticMatch } from './components/CompactDiagnosticMatch';
import { CompactStatsBar } from './components/CompactStatsBar';
import { DualCtaFooter } from './components/DualCtaFooter';
  ...
  return (
    <main className="h-screen flex flex-col bg-white overflow-hidden">
      <div className="flex-1 flex flex-col justify-center min-h-0">
        <CompactDiagnosticMatch content={content} />
      </div>
      <CompactStatsBar content={content} />
      <DualCtaFooter content={content} />
    </main>
  );
}
